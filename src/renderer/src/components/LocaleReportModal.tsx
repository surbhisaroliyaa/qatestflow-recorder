      ...
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="ac-body">
          <p className="api-hint">
            Each language replays your test, then checks three things: did the text actually{' '}
            <strong>translate</strong>, did the <strong>layout hold</strong> (no text cut off that
            fit fine in the base language), and did right-to-left languages like Arabic{' '}
            <strong>flip direction</strong> correctly. A green ✓ means all three are fine. Hover a
            row for the raw numbers.
          </p>
          {(() => {
            const rows = localeRun.results.map((r, i) => {
              ...
              const clean = r.ok && extraOverflow === 0 && !rtlIssue && (untr === null || untr < 85)
