    ...
    >
      <div className="a11y-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="help-note">
                ...
                <ul>
                  <li>
                    ...
                    <strong>serious</strong> major barrier · <strong>moderate</strong> noticeable ·{' '}
                    <strong>minor</strong> cosmetic.
                  </li>
                  <li>
                    Each is <strong>axe-core&apos;s</strong> own rating of how much the issue blocks
                    someone using a screen reader / keyboard.
                  </li>
                  <li>
        ...
        <div className="modal-footer">
          ...
          <button className="modal-btn" onClick={() => setA11yScan(null)} disabled={a11yScanning}>
            Close
          </button>
          <button className="modal-btn primary" onClick={handleA11yScan} disabled={a11yScanning}>
            ↻ Re-scan
          </button>
        </div>
      </div>
