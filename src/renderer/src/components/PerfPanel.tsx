          ...
          <>
            ...
            <div className="a11y-body">
              ...
              <div className="help-note">
                ...
                <ul>
                  <li>
                    <strong>CORE</strong> (LCP, CLS) = Google&apos;s Core Web Vitals — these are the{' '}
                    <strong>only</strong> two that pass/fail the test. The rest are context.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>INFO</strong> = shown for context, no official pass/fail line, so not
                    graded.
                  </li>
                </ul>
              </div>
