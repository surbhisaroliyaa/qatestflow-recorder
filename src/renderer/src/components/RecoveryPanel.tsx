...
export interface RecoveryPanelProps {
  ...
  setRepickPending: React.Dispatch<
  ...
  return (
    <div className="assert-panel recovery-panel">
      ...
      {repickPending ? (
        ...
        <div className="assert-actions recovery-actions">
          <span className="recovery-hint">Click the correct element in the page (Esc cancels)</span>
            ...
            ((recovery.suggestion.ambiguousCount ?? 1) > 1 ? (
              <div className="self-heal self-heal-ambiguous">
                <span className="self-heal-text">
                  🔧 Self-heal found <strong>{recovery.suggestion.ambiguousCount}</strong> elements
                  labelled <strong>“{recovery.suggestion.label}”</strong> — too ambiguous to fix
                  automatically. Use <strong>🎯 Pick manually</strong> below to choose the right
                  one.
                </span>
              </div>
            ) : (
              <div className="self-heal">
                <span className="self-heal-text">
                  🔧 Self-heal found <strong>“{recovery.suggestion.label}”</strong> — use it to fix
                  this step?
                </span>
                <button
                  type="button"
            ...
            {recovery.visual?.baselineId && (
              <button
                ...
                onClick={async () => {
                  ...
                  const ok = await window.api.visual.updateBaseline(v.baselineId!, v.currentPath)
