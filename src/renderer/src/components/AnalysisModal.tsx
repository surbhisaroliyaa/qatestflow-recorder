    ...
    <div className="modal-backdrop" onClick={closeAnalysis}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        <div className="modal-header">
          <span className="modal-title">{bugReport ? '🐞 Bug report' : '💡 Failure analysis'}</span>
        ...
        {bugReport ? (
          ...
          <div className="analysis-body">
            ...
            {analysis.suggestion && <p className="analysis-suggestion">→ {analysis.suggestion}</p>}
            {lastEvidence &&
        ...
        <div className="modal-footer">
          {bugReport ? (
            <>
              {reportSavedPath && <span className="saved-path">Saved to {reportSavedPath}</span>}
