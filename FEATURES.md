...
a link to the evidence for each line. Known limits are listed under *Limitations* below.
...
- **Error injection (forced 500s)** is deferred: it would pause *every* request through the same
...
*Honest scope:* anything needing the real app window — recording inside the embedded browser,
